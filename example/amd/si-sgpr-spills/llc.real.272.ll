...
@G = addrspace(1) global <32 x double> splat (double 0x7FEFFFFFFFFFFFFF)
...
define internal i32 @__ockl_lane_u32() local_unnamed_addr #14 {
  %A = alloca <32 x double>, align 256, addrspace(5)
  store <32 x double> poison, ptr addrspace(5) %A, align 256
  %LGV1 = load <32 x double>, ptr addrspace(1) @G, align 256
  %B = frem <32 x double> splat (double 4.940660e-324), %LGV1
  %1 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
  %2 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 %1)
  store <32 x double> %B, ptr addrspace(5) %A, align 256
  ret i32 %2
}
