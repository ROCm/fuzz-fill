...
; %bb.20:
	...
	v_dual_mov_b32 v7, v12 :: v_dual_and_b32 v6, v5, v7
	s_delay_alu instid0(VALU_DEP_1)
...
.Lfunc_end8:
	.size	__assert_fail, .Lfunc_end8-__assert_fail
                                        ; -- End function
	.set .L__assert_fail.num_vgpr, max(54, .L__ockl_fprintf_stderr_begin.num_vgpr, .L__ockl_fprintf_append_string_n.num_vgpr, .L__ockl_fprintf_append_args.num_vgpr)
	.set .L__assert_fail.num_agpr, max(0, .L__ockl_fprintf_stderr_begin.num_agpr, .L__ockl_fprintf_append_string_n.num_agpr, .L__ockl_fprintf_append_args.num_agpr)
	.set .L__assert_fail.numbered_sgpr, max(77, .L__ockl_fprintf_stderr_begin.numbered_sgpr, .L__ockl_fprintf_append_string_n.numbered_sgpr, .L__ockl_fprintf_append_args.numbered_sgpr)
	.set .L__assert_fail.num_named_barrier, max(0, .L__ockl_fprintf_stderr_begin.num_named_barrier, .L__ockl_fprintf_append_string_n.num_named_barrier, .L__ockl_fprintf_append_args.num_named_barrier)
	.set .L__assert_fail.private_seg_size, 128+max(.L__ockl_fprintf_stderr_begin.private_seg_size, .L__ockl_fprintf_append_string_n.private_seg_size, .L__ockl_fprintf_append_args.private_seg_size)
	.set .L__assert_fail.uses_vcc, or(1, .L__ockl_fprintf_stderr_begin.uses_vcc, .L__ockl_fprintf_append_string_n.uses_vcc, .L__ockl_fprintf_append_args.uses_vcc)
	.set .L__assert_fail.uses_flat_scratch, or(1, .L__ockl_fprintf_stderr_begin.uses_flat_scratch, .L__ockl_fprintf_append_string_n.uses_flat_scratch, .L__ockl_fprintf_append_args.uses_flat_scratch)
	.set .L__assert_fail.has_dyn_sized_stack, or(0, .L__ockl_fprintf_stderr_begin.has_dyn_sized_stack, .L__ockl_fprintf_append_string_n.has_dyn_sized_stack, .L__ockl_fprintf_append_args.has_dyn_sized_stack)
	.set .L__assert_fail.has_recursion, or(0, .L__ockl_fprintf_stderr_begin.has_recursion, .L__ockl_fprintf_append_string_n.has_recursion, .L__ockl_fprintf_append_args.has_recursion)
	.set .L__assert_fail.has_indirect_call, or(0, .L__ockl_fprintf_stderr_begin.has_indirect_call, .L__ockl_fprintf_append_string_n.has_indirect_call, .L__ockl_fprintf_append_args.has_indirect_call)
	.section	.AMDGPU.csdata,"",@progbits
; Function info:
; codeLenInByte = 2176
; TotalNumSgprs: 81
...
.Lfunc_end9:
	.size	__assertfail, .Lfunc_end9-__assertfail
                                        ; -- End function
	.set .L__assertfail.num_vgpr, 0
	.set .L__assertfail.num_agpr, 0
	.set .L__assertfail.numbered_sgpr, 32
	.set .L__assertfail.num_named_barrier, 0
	.set .L__assertfail.private_seg_size, 0
	.set .L__assertfail.uses_vcc, 0
	.set .L__assertfail.uses_flat_scratch, 0
	.set .L__assertfail.has_dyn_sized_stack, 0
	.set .L__assertfail.has_recursion, 0
	.set .L__assertfail.has_indirect_call, 0
	.section	.AMDGPU.csdata,"",@progbits
; Function info:
; codeLenInByte = 28
; TotalNumSgprs: 32
...
.Lfunc_end13:
	.size	_Z13__syncthreadsv, .Lfunc_end13-_Z13__syncthreadsv
                                        ; -- End function
	.set .L_Z13__syncthreadsv.num_vgpr, max(5, .L_ZL9__barrieri.num_vgpr)
	.set .L_Z13__syncthreadsv.num_agpr, max(0, .L_ZL9__barrieri.num_agpr)
	.set .L_Z13__syncthreadsv.numbered_sgpr, max(34, .L_ZL9__barrieri.numbered_sgpr)
	.set .L_Z13__syncthreadsv.num_named_barrier, max(0, .L_ZL9__barrieri.num_named_barrier)
	.set .L_Z13__syncthreadsv.private_seg_size, 16+max(.L_ZL9__barrieri.private_seg_size)
	.set .L_Z13__syncthreadsv.uses_vcc, or(0, .L_ZL9__barrieri.uses_vcc)
	.set .L_Z13__syncthreadsv.uses_flat_scratch, or(0, .L_ZL9__barrieri.uses_flat_scratch)
	.set .L_Z13__syncthreadsv.has_dyn_sized_stack, or(0, .L_ZL9__barrieri.has_dyn_sized_stack)
	.set .L_Z13__syncthreadsv.has_recursion, or(1, .L_ZL9__barrieri.has_recursion)
	.set .L_Z13__syncthreadsv.has_indirect_call, or(0, .L_ZL9__barrieri.has_indirect_call)
	.section	.AMDGPU.csdata,"",@progbits
; Function info:
; codeLenInByte = 180
; TotalNumSgprs: 34
...
; %bb.3:                                ; %BB
	...
	s_wait_alu depctr_sa_sdst(0)
	v_dual_mov_b32 v1, s3 :: v_dual_mov_b32 v0, s1
	v_mov_b32_e32 v3, 4
...
.Lfunc_end14:
	.size	_Z8crc_initv, .Lfunc_end14-_Z8crc_initv
                                        ; -- End function
	.set .L_Z8crc_initv.num_vgpr, max(41, .L__ockl_get_local_id.num_vgpr, .L_Z13__syncthreadsv.num_vgpr)
	.set .L_Z8crc_initv.num_agpr, max(0, .L__ockl_get_local_id.num_agpr, .L_Z13__syncthreadsv.num_agpr)
	.set .L_Z8crc_initv.numbered_sgpr, max(34, .L__ockl_get_local_id.numbered_sgpr, .L_Z13__syncthreadsv.numbered_sgpr)
	.set .L_Z8crc_initv.num_named_barrier, max(0, .L__ockl_get_local_id.num_named_barrier, .L_Z13__syncthreadsv.num_named_barrier)
	.set .L_Z8crc_initv.private_seg_size, 32+max(.L__ockl_get_local_id.private_seg_size, .L_Z13__syncthreadsv.private_seg_size)
	.set .L_Z8crc_initv.uses_vcc, or(1, .L__ockl_get_local_id.uses_vcc, .L_Z13__syncthreadsv.uses_vcc)
	.set .L_Z8crc_initv.uses_flat_scratch, or(0, .L__ockl_get_local_id.uses_flat_scratch, .L_Z13__syncthreadsv.uses_flat_scratch)
	.set .L_Z8crc_initv.has_dyn_sized_stack, or(0, .L__ockl_get_local_id.has_dyn_sized_stack, .L_Z13__syncthreadsv.has_dyn_sized_stack)
	.set .L_Z8crc_initv.has_recursion, or(1, .L__ockl_get_local_id.has_recursion, .L_Z13__syncthreadsv.has_recursion)
	.set .L_Z8crc_initv.has_indirect_call, or(0, .L__ockl_get_local_id.has_indirect_call, .L_Z13__syncthreadsv.has_indirect_call)
	.section	.AMDGPU.csdata,"",@progbits
; Function info:
; codeLenInByte = 392
; TotalNumSgprs: 36
...
.Lfunc_end15:
	.size	_Z9crc_tablejj, .Lfunc_end15-_Z9crc_tablejj
                                        ; -- End function
	.set .L_Z9crc_tablejj.num_vgpr, max(42, .L_Z8crc_initv.num_vgpr)
	.set .L_Z9crc_tablejj.num_agpr, max(0, .L_Z8crc_initv.num_agpr)
	.set .L_Z9crc_tablejj.numbered_sgpr, max(40, .L_Z8crc_initv.numbered_sgpr)
	.set .L_Z9crc_tablejj.num_named_barrier, max(0, .L_Z8crc_initv.num_named_barrier)
	.set .L_Z9crc_tablejj.private_seg_size, 32+max(.L_Z8crc_initv.private_seg_size)
	.set .L_Z9crc_tablejj.uses_vcc, or(1, .L_Z8crc_initv.uses_vcc)
	.set .L_Z9crc_tablejj.uses_flat_scratch, or(0, .L_Z8crc_initv.uses_flat_scratch)
	.set .L_Z9crc_tablejj.has_dyn_sized_stack, or(0, .L_Z8crc_initv.has_dyn_sized_stack)
	.set .L_Z9crc_tablejj.has_recursion, or(1, .L_Z8crc_initv.has_recursion)
	.set .L_Z9crc_tablejj.has_indirect_call, or(0, .L_Z8crc_initv.has_indirect_call)
	.section	.AMDGPU.csdata,"",@progbits
; Function info:
; codeLenInByte = 768
; TotalNumSgprs: 42
...
; %bb.0:                                ; %entry
	...
	s_add_co_i32 s3, s32, 8
	s_wait_alu depctr_sa_sdst(0)
	s_mov_b32 s2, s3
	s_add_co_i32 s3, s32, 12
	s_wait_alu depctr_sa_sdst(0)
	s_mov_b32 s4, s3
	s_mov_b32 s3, s5
	...
	v_dual_mov_b32 v5, s5 :: v_dual_mov_b32 v0, s4
	v_mov_b32_e32 v1, s5
	s_mov_b32 s4, 0
                                        ; implicit-def: $sgpr5
	s_wait_loadcnt_dscnt 0x0
...
.Lfunc_end16:
	.size	_Z8crc_loopjj, .Lfunc_end16-_Z8crc_loopjj
                                        ; -- End function
	.set .L_Z8crc_loopjj.num_vgpr, 8
	.set .L_Z8crc_loopjj.num_agpr, 0
	.set .L_Z8crc_loopjj.numbered_sgpr, 33
	.set .L_Z8crc_loopjj.num_named_barrier, 0
	.set .L_Z8crc_loopjj.private_seg_size, 20
	.set .L_Z8crc_loopjj.uses_vcc, 0
	.set .L_Z8crc_loopjj.uses_flat_scratch, 0
	.set .L_Z8crc_loopjj.has_dyn_sized_stack, 0
	.set .L_Z8crc_loopjj.has_recursion, 0
	.set .L_Z8crc_loopjj.has_indirect_call, 0
	.section	.AMDGPU.csdata,"",@progbits
; Function info:
; codeLenInByte = 524
; TotalNumSgprs: 33
...
; %bb.0:                                ; %entry
	...
	s_mov_b32 s33, s32
	s_or_saveexec_b32 s1, -1
	scratch_store_b32 off, v56, s33 offset:56 ; 4-byte Folded Spill
	s_wait_alu depctr_sa_sdst(0)
	s_mov_b32 exec_lo, s1
	...
	v_writelane_b32 v56, s36, 4
	v_writelane_b32 v56, s37, 5
	v_writelane_b32 v56, s38, 6
	v_writelane_b32 v56, s39, 7
	v_writelane_b32 v56, s48, 8
	v_writelane_b32 v56, s49, 9
	s_mov_b64 s[48:49], s[10:11]
	v_writelane_b32 v56, s50, 10
	v_writelane_b32 v56, s51, 11
	s_mov_b64 s[50:51], s[8:9]
	v_writelane_b32 v56, s52, 12
	v_writelane_b32 v56, s53, 13
	s_mov_b64 s[52:53], s[6:7]
	v_writelane_b32 v56, s54, 14
	v_writelane_b32 v56, s55, 15
	s_mov_b64 s[54:55], s[4:5]
	v_writelane_b32 v56, s64, 16
	s_mov_b32 s64, s15
	v_writelane_b32 v56, s65, 17
	s_mov_b32 s65, s14
	v_writelane_b32 v56, s66, 18
	s_mov_b32 s66, s13
	v_writelane_b32 v56, s67, 19
	s_mov_b32 s67, s12
	v_writelane_b32 v56, s68, 20
	s_wait_alu depctr_sa_sdst(0)
	s_mov_b32 s68, s0
	s_add_co_i32 s0, s33, 48
	v_writelane_b32 v56, s69, 21
	s_mov_b32 s69, s1
	...
	v_writelane_b32 v56, s70, 22
	s_mov_b32 s70, s0
	s_add_co_i32 s0, s33, 52
	s_getpc_b64 s[2:3]
	s_wait_alu depctr_sa_sdst(0)
	s_sext_i32_i16 s3, s3
...
; %bb.1:                                ; %if.then
	v_dual_mov_b32 v0, s68 :: v_dual_mov_b32 v1, s69
	v_mov_b32_e32 v2, 1
	flat_load_b64 v[0:1], v[0:1]
	s_wait_loadcnt_dscnt 0x0
	flat_store_b32 v[0:1], v2
.LBB17_2:                               ; %if.end
	...
	v_readlane_b32 s71, v56, 23
	v_readlane_b32 s70, v56, 22
	v_readlane_b32 s69, v56, 21
	v_readlane_b32 s68, v56, 20
	v_readlane_b32 s67, v56, 19
	v_readlane_b32 s66, v56, 18
	v_readlane_b32 s65, v56, 17
	v_readlane_b32 s64, v56, 16
	v_readlane_b32 s55, v56, 15
	v_readlane_b32 s54, v56, 14
	v_readlane_b32 s53, v56, 13
	v_readlane_b32 s52, v56, 12
	v_readlane_b32 s51, v56, 11
	v_readlane_b32 s50, v56, 10
	v_readlane_b32 s49, v56, 9
	v_readlane_b32 s48, v56, 8
	v_readlane_b32 s39, v56, 7
	v_readlane_b32 s38, v56, 6
	v_readlane_b32 s37, v56, 5
	v_readlane_b32 s36, v56, 4
	...
	s_or_saveexec_b32 s1, -1
	scratch_load_b32 v56, off, s33 offset:56 ; 4-byte Folded Reload
	s_wait_alu depctr_sa_sdst(0)
	s_mov_b32 exec_lo, s1
	s_mov_b32 s33, s0
	s_wait_loadcnt_dscnt 0x0
...
.Lfunc_end17:
	.size	_Z13VERIFY_RESULTjjPi, .Lfunc_end17-_Z13VERIFY_RESULTjjPi
                                        ; -- End function
	.set .L_Z13VERIFY_RESULTjjPi.num_vgpr, max(57, .L_Z9crc_tablejj.num_vgpr, .L_Z8crc_loopjj.num_vgpr)
	.set .L_Z13VERIFY_RESULTjjPi.num_agpr, max(0, .L_Z9crc_tablejj.num_agpr, .L_Z8crc_loopjj.num_agpr)
	.set .L_Z13VERIFY_RESULTjjPi.numbered_sgpr, max(72, .L_Z9crc_tablejj.numbered_sgpr, .L_Z8crc_loopjj.numbered_sgpr)
	.set .L_Z13VERIFY_RESULTjjPi.num_named_barrier, max(0, .L_Z9crc_tablejj.num_named_barrier, .L_Z8crc_loopjj.num_named_barrier)
	.set .L_Z13VERIFY_RESULTjjPi.private_seg_size, 64+max(.L_Z9crc_tablejj.private_seg_size, .L_Z8crc_loopjj.private_seg_size)
	.set .L_Z13VERIFY_RESULTjjPi.uses_vcc, or(1, .L_Z9crc_tablejj.uses_vcc, .L_Z8crc_loopjj.uses_vcc)
	.set .L_Z13VERIFY_RESULTjjPi.uses_flat_scratch, or(1, .L_Z9crc_tablejj.uses_flat_scratch, .L_Z8crc_loopjj.uses_flat_scratch)
	.set .L_Z13VERIFY_RESULTjjPi.has_dyn_sized_stack, or(0, .L_Z9crc_tablejj.has_dyn_sized_stack, .L_Z8crc_loopjj.has_dyn_sized_stack)
	.set .L_Z13VERIFY_RESULTjjPi.has_recursion, or(1, .L_Z9crc_tablejj.has_recursion, .L_Z8crc_loopjj.has_recursion)
	.set .L_Z13VERIFY_RESULTjjPi.has_indirect_call, or(0, .L_Z9crc_tablejj.has_indirect_call, .L_Z8crc_loopjj.has_indirect_call)
	.section	.AMDGPU.csdata,"",@progbits
; Function info:
; codeLenInByte = 1148
; TotalNumSgprs: 76
...
.Lfunc_end19:
	.size	__ockl_get_local_size, .Lfunc_end19-__ockl_get_local_size
                                        ; -- End function
	.set .L__ockl_get_local_size.num_vgpr, 2
...
.Lfunc_end20:
	.size	_Z9atomicAddPii, .Lfunc_end20-_Z9atomicAddPii
                                        ; -- End function
	.set .L_Z9atomicAddPii.num_vgpr, 9
	.set .L_Z9atomicAddPii.num_agpr, 0
	.set .L_Z9atomicAddPii.numbered_sgpr, 33
	.set .L_Z9atomicAddPii.num_named_barrier, 0
	.set .L_Z9atomicAddPii.private_seg_size, 24
	.set .L_Z9atomicAddPii.uses_vcc, 0
	.set .L_Z9atomicAddPii.uses_flat_scratch, 0
	.set .L_Z9atomicAddPii.has_dyn_sized_stack, 0
	.set .L_Z9atomicAddPii.has_recursion, 0
	.set .L_Z9atomicAddPii.has_indirect_call, 0
	.section	.AMDGPU.csdata,"",@progbits
; Function info:
; codeLenInByte = 148
; TotalNumSgprs: 33
...
.Lfunc_end21:
	...
	.text
                                        ; -- End function
	.set .Ltest_crc_kernel.num_vgpr, max(48, .L_Z8crc_initv.num_vgpr, .L__ockl_get_local_id.num_vgpr, .L__ockl_get_group_id.num_vgpr, .L__ockl_get_local_size.num_vgpr, .L_Z13__syncthreadsv.num_vgpr, .L_Z13VERIFY_RESULTjjPi.num_vgpr, .L_Z9atomicAddPii.num_vgpr)
	.set .Ltest_crc_kernel.num_agpr, max(0, .L_Z8crc_initv.num_agpr, .L__ockl_get_local_id.num_agpr, .L__ockl_get_group_id.num_agpr, .L__ockl_get_local_size.num_agpr, .L_Z13__syncthreadsv.num_agpr, .L_Z13VERIFY_RESULTjjPi.num_agpr, .L_Z9atomicAddPii.num_agpr)
	.set .Ltest_crc_kernel.numbered_sgpr, max(100, .L_Z8crc_initv.numbered_sgpr, .L__ockl_get_local_id.numbered_sgpr, .L__ockl_get_group_id.numbered_sgpr, .L__ockl_get_local_size.numbered_sgpr, .L_Z13__syncthreadsv.numbered_sgpr, .L_Z13VERIFY_RESULTjjPi.numbered_sgpr, .L_Z9atomicAddPii.numbered_sgpr)
	.set .Ltest_crc_kernel.num_named_barrier, max(0, .L_Z8crc_initv.num_named_barrier, .L__ockl_get_local_id.num_named_barrier, .L__ockl_get_group_id.num_named_barrier, .L__ockl_get_local_size.num_named_barrier, .L_Z13__syncthreadsv.num_named_barrier, .L_Z13VERIFY_RESULTjjPi.num_named_barrier, .L_Z9atomicAddPii.num_named_barrier)
	.set .Ltest_crc_kernel.private_seg_size, 32+max(.L_Z8crc_initv.private_seg_size, .L__ockl_get_local_id.private_seg_size, .L__ockl_get_group_id.private_seg_size, .L__ockl_get_local_size.private_seg_size, .L_Z13__syncthreadsv.private_seg_size, .L_Z13VERIFY_RESULTjjPi.private_seg_size, .L_Z9atomicAddPii.private_seg_size)
	.set .Ltest_crc_kernel.uses_vcc, or(1, .L_Z8crc_initv.uses_vcc, .L__ockl_get_local_id.uses_vcc, .L__ockl_get_group_id.uses_vcc, .L__ockl_get_local_size.uses_vcc, .L_Z13__syncthreadsv.uses_vcc, .L_Z13VERIFY_RESULTjjPi.uses_vcc, .L_Z9atomicAddPii.uses_vcc)
	.set .Ltest_crc_kernel.uses_flat_scratch, or(0, .L_Z8crc_initv.uses_flat_scratch, .L__ockl_get_local_id.uses_flat_scratch, .L__ockl_get_group_id.uses_flat_scratch, .L__ockl_get_local_size.uses_flat_scratch, .L_Z13__syncthreadsv.uses_flat_scratch, .L_Z13VERIFY_RESULTjjPi.uses_flat_scratch, .L_Z9atomicAddPii.uses_flat_scratch)
	.set .Ltest_crc_kernel.has_dyn_sized_stack, or(0, .L_Z8crc_initv.has_dyn_sized_stack, .L__ockl_get_local_id.has_dyn_sized_stack, .L__ockl_get_group_id.has_dyn_sized_stack, .L__ockl_get_local_size.has_dyn_sized_stack, .L_Z13__syncthreadsv.has_dyn_sized_stack, .L_Z13VERIFY_RESULTjjPi.has_dyn_sized_stack, .L_Z9atomicAddPii.has_dyn_sized_stack)
	.set .Ltest_crc_kernel.has_recursion, or(1, .L_Z8crc_initv.has_recursion, .L__ockl_get_local_id.has_recursion, .L__ockl_get_group_id.has_recursion, .L__ockl_get_local_size.has_recursion, .L_Z13__syncthreadsv.has_recursion, .L_Z13VERIFY_RESULTjjPi.has_recursion, .L_Z9atomicAddPii.has_recursion)
	.set .Ltest_crc_kernel.has_indirect_call, or(0, .L_Z8crc_initv.has_indirect_call, .L__ockl_get_local_id.has_indirect_call, .L__ockl_get_group_id.has_indirect_call, .L__ockl_get_local_size.has_indirect_call, .L_Z13__syncthreadsv.has_indirect_call, .L_Z13VERIFY_RESULTjjPi.has_indirect_call, .L_Z9atomicAddPii.has_indirect_call)
	.section	.AMDGPU.csdata,"",@progbits
; Kernel info:
; codeLenInByte = 964
; TotalNumSgprs: 104
