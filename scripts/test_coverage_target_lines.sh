...
# End-to-end: added-lines -> LIT baseline -> target-lines uncovered list.
...
# 2) Baseline suite coverage (required line_coverage_status.csv under TEST_SUITE_OUTPUT_DIR)
