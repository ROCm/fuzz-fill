...
@G = addrspace(1) global <8 x i1> zeroinitializer
...
entry:
  %LGV = load <8 x i1>, ptr addrspace(1) @G, align 1
  %retval = alloca i32, align 4
  %C = icmp eq <8 x i1> %LGV, zeroinitializer
  %retval.ascast = addrspacecast ptr %retval to ptr addrspace(4)
  %call = call spir_func addrspace(4) i64 @__ockl_get_group_id(i32 noundef 0) #12
  %conv = trunc i64 %call to i32
  store <8 x i1> %C, ptr addrspace(4) %retval.ascast, align 1
  ret i32 %conv
}
